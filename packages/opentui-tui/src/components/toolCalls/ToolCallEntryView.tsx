...
// ToolCallEntryView dispatches a transcript entry's ToolCallDetail to the
// correct per-tool card. All cards accept the same renderState / durationMs /
// errorText shape, so the dispatcher stays tiny and exhaustively typed over
// ToolCallDetail's discriminated union.
